            ...
            >
              <Dialog.Panel
                className={classNames(
                  "relative -translate-y-16 transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all dark:bg-neutral-950 sm:my-8 sm:w-full sm:p-6",
        ...
        <div key={`key-statusmodal-${title}`}>
          <div className="flex items-center justify-center">
            <div className=" pr-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <Dialog.Title
                as="h3"
                className="text-center text-base font-semibold leading-6 text-gray-900 dark:text-white"
              >
                {title}
              </Dialog.Title>
